...
from app.routes import auth, medicines, medications, ocr, medication_requests, profile, users
...
app.include_router(medication_requests.router, prefix="/medications", tags=["Medication-requests"])
